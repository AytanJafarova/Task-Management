...
public class ResponseMessage {
    ...
    public static final String ERROR_ORGANIZATION_NOT_FOUND_BY_ID = "Organization not found by id";
    ...
    public static final String ERROR_TASK_NOT_FOUND_BY_ID = "Task not found by id";
    ...
    public static final String ERROR_WORKER_NOT_FOUND_BY_ID = "Worker not found by id";
